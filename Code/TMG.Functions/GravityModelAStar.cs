...
{
    public sealed class GravityModelAStar
    {
        ...
        public GravityModelAStar(Func<int, int, double> frictionFunction, Action<float> progressCallback = null, float epsilon = 0.8f, int maxIterations = 100)
        {
            Epsilon = epsilon;
        ...
        public GravityModelAStar(SparseTwinIndex<float> friction, Action<float> progressCallback = null, float epsilon = 0.8f, int maxIterations = 100)
        {
            Epsilon = epsilon;
            Friction = friction;
            MaxIterations = maxIterations;
        ...
        public SparseArray<float> ProcessModelAStar(SparseArray<float> o, SparseArray<float> d, int[] validIndexes, SparseArray<float> attractionStar = null)
        {
