...
public class CopyBackgroundTraffic : IEmmeTool
{
    ...
    {
        var mc = controller as ModellerController ?? throw new XTMFRuntimeException(this, "TMG.Emme.CopyBackgroundTraffic requires the use of EMME Modeller and will not work through command prompt!");
        string ret = null;
