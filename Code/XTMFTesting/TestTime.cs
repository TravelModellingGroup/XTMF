...
namespace XTMF.Testing
{
    ...
    public class TestTime
    {
        ...
        public void TestIntersection()
        {
            ...
            {
                Assert.Fail( "We were expecting to have an intersection of 1 hour, instead of had " + intersection.ToString() );
            }
        }
        ...
        private void CheckTime(Time time, int hours, int minutes, int seconds)
        {
            ...
            {
                Assert.Fail( String.Format( "{0} is not equal to {1}:{2}:{3}!", time.ToString(), hours, minutes, seconds ) );
            }
        }
