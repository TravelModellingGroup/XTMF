...
{
    public class NPVNetworkMode : ITashaMode
    {
        [RootModule]
        ...
        [RunParameter("TravelTimeScale", 1.0f, "The factor applied to the network data for this mode.")]
        public float TravelTimeScale;

        [Parameter( "Demographic Category Feasible", 1f, "(Automated by IModeParameterDatabase)\r\nIs the currently processing demographic category feasible?" )]
        public float CurrentlyFeasible { get; set; }

        [RunParameter("Max Time", "0:00", typeof(Time), "The maximum time span before this mode is infeasible. 0:00 for infinite.")]
        public Time MaxTime;

        private bool TestMaxTime = false;
        ...
        public bool Feasible(ITrip trip)
        {
            ...
            if ( TestMaxTime && trip.TravelTime > MaxTime )
            {
                return false;
            }
        ...
        public double CalculateV(ITrip trip)
        {
            ...
            var totalTime = this.TravelTimeScale * this.NetworkData.TravelTime(origin, destination, startTime).ToMinutes();
        ...
        {
            return this.TravelTimeScale * this.NetworkData.TravelTime( origin, destination, time );
        }
