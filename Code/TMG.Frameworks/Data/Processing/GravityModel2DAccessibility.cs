...
{
    [ModuleInformation(Description = "This module provides an easy way to gather the accessibility of a gravity model given production, attraction, and the friction.")]
    public sealed class GravityModel2DAccessibility : IDataSource<SparseArray<float>>
    {
        public bool Loaded
        {
        ...
        public void LoadData()
        {
            ...
            var model = new GravityModelAccessibility(friction, (p) => Progress = p, MaximumError, MaxIterations);
            _data = model.ProcessAccessibility(production, attraction, production.ValidIndexArray());
        }
