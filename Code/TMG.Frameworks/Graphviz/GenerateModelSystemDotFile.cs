...
namespace TMG.Frameworks.Graphviz
{
    public class GenerateModelSystemDotFile : ISelfContainedModule
    {
        ...
        [RunParameter("Include Descriptions", false,
            "Flag for including module descriptions in the generated dot file.")]
        ...
        [RunParameter("Model System", "",
            "The name of the model system under the current project to create a dot file for. Leaving this paramter" +
        ...
        public string Name
        {
            get { return "Generate Model System Dot File"; }
            set { }
        }
        ...
        private void WriteModuleRanks(List<IModelSystemStructure> sameRankModules, StreamWriter writer)
        {
        }
        ...
        {
            if (module.Required && module.Type == null && !IncludeUnused && !module.IsCollection) return;
