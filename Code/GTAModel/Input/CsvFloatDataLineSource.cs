...
{
    public class CsvFloatDataLineSource : IDataLineSource<float[]>
    {
        ...
        [RunParameter( "Header Lines", 1, "The number of lines before the data starts." )]
