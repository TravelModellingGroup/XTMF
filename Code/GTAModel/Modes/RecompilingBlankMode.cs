...
namespace TMG.GTAModel.Modes
{
    public class RecompilingBlankMode : IUtilityComponentMode
    {
        ...
        {
            throw new XTMFRuntimeException( "This method should never be actually called." );
        }
        ...
        {
            IUtilityComponentMode optimizedMode;
            if ( !CreateOptimizedMode( out optimizedMode, ref error ) )
            {
                return false;
            }
        ...
        private void AttachFeasible(CodeTypeDeclaration modeClass)
        {
            ...
            feasibleMethod.Name = "Feasible";
            feasibleMethod.Attributes = MemberAttributes.Final | MemberAttributes.Public;
            feasibleMethod.ReturnType = new CodeTypeReference( typeof( bool ) );
        ...
        private void AttachRuntimeValidation(CodeTypeDeclaration modeClass)
        {
            ...
            runtimeValidation.Name = "RuntimeValidation";
            runtimeValidation.Attributes = MemberAttributes.Public | MemberAttributes.Final;
            runtimeValidation.ReturnType = new CodeTypeReference( typeof( bool ) );
        ...
        private void AttachUtilityComponentInitializationMethod(CodeTypeDeclaration modeClass)
        {
            ...
            calculateV.Name = "CalculateV";
            calculateV.ReturnType = new CodeTypeReference( typeof( float ) );
            calculateV.Attributes = MemberAttributes.Public | MemberAttributes.Final;
        ...
        private void SetupUtilityComponentField(CodeTypeDeclaration modeClass, CodeMemberMethod initializeUtilityComponents, CodeMemberMethod calculateV, int utilityComponentIndex)
        {
            ...
            utilityVariable.Attributes = MemberAttributes.Private;
