...
namespace James.UTDM
{
    ...
    {
        [RunParameter("Input Directory", "../../Input", "The directory that contains the model's input.")]
        ...
        [SubModelInformation(Required = false, Description = "The remainder of the model")]
        public ISelfContainedModule InnerModel;
