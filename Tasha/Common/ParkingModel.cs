...
namespace Tasha.Common
{
    ...
    public class ParkingModel : IParkingCost
    {
        ...
        [SubModelInformation(Required = true, Description = "CSV of (Zone,StartOfDay,DailyHourly,DailyMax,StartOfNight,NightlyHourly,NightlyMax)")]
        ...
        public float ComputeParkingCost(Time parkingStart, Time parkingEnd, IZone zone)
        {
            ...
            if (zoneIndex >= 0)
            {
                ...
                ref var zoneData = ref _parkingInformation[zoneIndex];
                float cost = 0.0f;
                /*
